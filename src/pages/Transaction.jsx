    ...
    <>
      ...
      <main className="m-10 items-center justify-center">
        <div className="flex justify-between px-20 mb-10">
          <div className="bg-green-600 w-[30%] h-12 rounded text-center text-white p-2 font-semibold text-xl">
            Success
          </div>
          <div className="bg-yellow-400 w-[30%] rounded text-center text-white p-2 font-semibold text-xl">
            Pending
          </div>
          <div className="bg-red-600 w-[30%] rounded text-center text-white p-2 font-semibold text-xl">
            Failed
          </div>
        </div>
          ...
          <table className="table-auto w-full border-collapse  ">
            ...
            <tbody>
              <tr className="border border-gray-300">
                ...
                <td className="border border-gray-300 px-6 py-2 text-center text-red-500">
                  Failed
                </td>
                <td className="border border-gray-300 px-6 py-2 text-center">
                  Lorem, ipsum.
              ...
              <tr className="border border-gray-300">
                ...
                <td className="border border-gray-300 px-6 py-2 text-center text-green-500">
                  Success
                </td>
                <td className="border border-gray-300 px-6 py-2 text-center">
                  Lorem, ipsum.
              ...
              <tr className="border border-gray-300">
                ...
                <td className="border border-gray-300 px-6 py-2 text-center text-yellow-500">
                  Pending
                </td>
                <td className="border border-gray-300 px-6 py-2 text-center">
                  Lorem, ipsum.
